...
const skills = {
  ...
  skillsList: [
    {
      icon: <Image src="/assets/skills/react.svg" alt="icon" width={50} height={50}  />,
      name: 'React',
    },
    {
      icon: <Image src="/assets/skills/javascript.svg" alt="icon" width={50} height={50} />,
      name: 'JavaScript',
    },
    {
      icon: <Image src="/assets/skills/node.svg" alt="icon" width={50} height={50} />,
      name: 'Node',
    },
    {
      icon: <Image src="/assets/skills/tailwind.svg" alt="icon" width={50} height={50} />,
      name: 'TailwindCSS',
    },
    {
      icon: <Image src="/assets/skills/sequelize.svg" alt="icon" width={50} height={50} />,
      name: 'SequelizeORM',
    },
    {
      icon: <Image src="/assets/skills/prisma.svg" alt="icon" width={50} height={50} />,
      name: 'PrismaORM',
    },
    {
      icon: <Image src="/assets/skills/git.svg" alt="icon" width={50} height={50} />,
      name: 'Git',
    },
    {
      icon: <Image src="/assets/skills/github.svg" alt="icon" width={50} height={50} />,
      name: 'GitHub',
    },
    {
      icon: <Image src="/assets/skills/docker.svg" alt="icon" width={50} height={50} />,
      name: 'Docker',
    },
    {
      icon: <Image src="/assets/skills/postgres.svg" alt="icon" width={50} height={50} />,
      name: 'PostgresSQL',
    },
    {
      icon: <Image src="/assets/skills/mongodb.svg" alt="icon" width={50} height={50} />,
      name: 'MongoDB',
    },
    {
      icon: <Image src="/assets/skills/wordpress.svg" alt="icon" width={50} height={50} />,
      name: 'Wordpress',
    },
    {
      icon: <Image src="/assets/skills/html5.svg" alt="icon" width={50} height={50} />,
      name: 'HTML5',
    },
    {
      icon: <Image src="/assets/skills/css3.svg" alt="icon" width={50} height={50} />,
      name: 'CSS3',
    },
    {
      icon: <Image src="/assets/skills/vitejs.svg" alt="icon" width={50} height={50} />,
      name: 'Vite',
    },
    {
      icon: <Image src="/assets/skills/typescript.svg" alt="icon" width={50} height={50} />,
      name: 'TypeScript',
    },
    {
      icon: <Image src="/assets/skills/nextjs.svg" alt="icon" width={50} height={50} />,
      name: 'Next',
    },
    {
      icon: <Image src="/assets/skills/jest.svg" alt="icon" width={50} height={50} />,
      name: 'Jest',
    },
    {
      icon: <Image src="/assets/skills/figma.svg" alt="icon" width={50} height={50} />,
      name: 'Figma',
    },
    {
      icon: <Image src="/assets/skills/react.svg" alt="icon" width={50} height={50} />,

...
const skills = {
  ...
  skillsList: [
    ...
    {
      icon: <Image src="/assets/skills/javascript.svg" alt="icon" wid />,
      name: 'JavaScript',
    },
    {
      icon: <Image src="/assets/skills/node.svg" alt="icon" wid />,
      name: 'Node',
    },
    {
      icon: <Image src="/assets/skills/tailwind.svg" alt="icon" wid />,
      name: 'TailwindCSS',
    },
    {
      icon: <Image src="/assets/skills/sequelize.svg" alt="icon" wid />,
      name: 'SequelizeORM',
    },
    {
      icon: <Image src="/assets/skills/prisma.svg" alt="icon" wid />,
      name: 'PrismaORM',
    },
    {
      icon: <Image src="/assets/skills/git.svg" alt="icon" wid />,
      name: 'Git',
    },
    {
      icon: <Image src="/assets/skills/github.svg" alt="icon" wid />,
      name: 'GitHub',
    },
    {
      icon: <Image src="/assets/skills/docker.svg" alt="icon" wid />,
      name: 'Docker',
    },
    {
      icon: <Image src="/assets/skills/postgres.svg" alt="icon" wid />,
      name: 'PostgresSQL',
    },
    {
      icon: <Image src="/assets/skills/mongodb.svg" alt="icon" wid />,
      name: 'MongoDB',
    },
    {
      icon: <Image src="/assets/skills/wordpress.svg" alt="icon" wid />,
      name: 'Wordpress',
    },
    {
      icon: <Image src="/assets/skills/html5.svg" alt="icon" wid />,
      name: 'HTML5',
    },
    {
      icon: <Image src="/assets/skills/css3.svg" alt="icon" wid />,
      name: 'CSS3',
    },
    {
      icon: <Image src="/assets/skills/vitejs.svg" alt="icon" wid />,
      name: 'Vite',
    },
    {
      icon: <Image src="/assets/skills/typescript.svg" alt="icon" wid />,
      name: 'TypeScript',
    },
    {
      icon: <Image src="/assets/skills/nextjs.svg" alt="icon" wid />,
      name: 'Next',
    },
    {
      icon: <Image src="/assets/skills/jest.svg" alt="icon" wid />,
      name: 'Jest',
    },
    {
      icon: <Image src="/assets/skills/figma.svg" alt="icon" wid />,
      name: 'Figma',
    },
    {
      icon: <Image src="/assets/skills/react.svg" alt="icon" wid />,
      name: '',
    },
  ],
};

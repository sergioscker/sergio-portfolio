...
const skills = {
  ...
  skillsList: [
    ...
    {
      icon: (
        <Image src="/assets/skills/git.svg" alt="icon" width={60} height={60} />
      ),
      name: 'Git',
    },
    {
    ...
    {
      icon: (
        <Image src="/assets/skills/css.svg" alt="icon" width={60} height={60} />
      ),
      name: 'CSS3',
    },
    {
                          ...
                          <Tooltip>
                            ...
                            <TooltipTrigger className="flex justify-center items-center w-[150px] h-[150px]  bg-gradient-to-b from-[#8c8c8c25] backdrop-blur-[4px] border border-white/10 rounded-xl group text-accent">
                              ...
                              >
                                ...
                                <p className="mt-3 text-sm text-center dark:text-white/80">
                                  {skill.name}
                                </p>
                              </div>
                            </TooltipTrigger>

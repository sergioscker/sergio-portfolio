...
const skills = {
  ...
  skillsList: [
    ...
    {
      icon: <Image src="/assets/skills/javascript.svg" alt="icon" width= />,
      name: 'JavaScript',
    },
    {
      icon: <Image src="/assets/skills/node.svg" alt="icon" width= />,
      name: 'Node',
    },
    {
      icon: <Image src="/assets/skills/tailwind.svg" alt="icon" width= />,
      name: 'TailwindCSS',
    },
    {
      icon: <Image src="/assets/skills/sequelize.svg" alt="icon" width= />,
      name: 'SequelizeORM',
    },
    {
      icon: <Image src="/assets/skills/prisma.svg" alt="icon" width= />,
      name: 'PrismaORM',
    },
    {
      icon: <Image src="/assets/skills/git.svg" alt="icon" width= />,
      name: 'Git',
    },
    {
      icon: <Image src="/assets/skills/github.svg" alt="icon" width= />,
      name: 'GitHub',
    },
    {
      icon: <Image src="/assets/skills/docker.svg" alt="icon" width= />,
      name: 'Docker',
    },
    {
      icon: <Image src="/assets/skills/postgres.svg" alt="icon" width= />,
      name: 'PostgresSQL',
    },
    {
      icon: <Image src="/assets/skills/mongodb.svg" alt="icon" width= />,
      name: 'MongoDB',
    },
    {
      icon: <Image src="/assets/skills/wordpress.svg" alt="icon" width= />,
      name: 'Wordpress',
    },
    {
      icon: <Image src="/assets/skills/html5.svg" alt="icon" width= />,
      name: 'HTML5',
    },
    {
      icon: <Image src="/assets/skills/css3.svg" alt="icon" width= />,
      name: 'CSS3',
    },
    {
      icon: <Image src="/assets/skills/vitejs.svg" alt="icon" width= />,
      name: 'Vite',
    },
    {
      icon: <Image src="/assets/skills/typescript.svg" alt="icon" width= />,
      name: 'TypeScript',
    },
    {
      icon: <Image src="/assets/skills/nextjs.svg" alt="icon" width= />,
      name: 'Next',
    },
    {
      icon: <Image src="/assets/skills/jest.svg" alt="icon" width= />,
      name: 'Jest',
    },
    {
      icon: <Image src="/assets/skills/figma.svg" alt="icon" width= />,
      name: 'Figma',
    },
    {
      icon: <Image src="/assets/skills/react.svg" alt="icon" width= />,
      name: '',
    },
  ],
};

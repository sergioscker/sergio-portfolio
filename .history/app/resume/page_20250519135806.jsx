...
const skills = {
  ...
  skillsList: [
    ...
    {
      icon: <Image src="/assets/skills/mongodb.svg" alt="icon" size={50} />,
      name: 'MongoDB',
    },
    {
      icon: <Image src="/assets/skills/wordpress.svg" alt="icon" size={50} />,
      name: 'Wordpress',
    },
    {
      icon: <Image src="/assets/skills/html5.svg" alt="icon" size={50} />,
      name: 'HTML5',
    },
    {
      icon: <Image src="/assets/skills/css3.svg" alt="icon" size={50} />,
      name: 'CSS3',
    },
    {
      icon: <Image src="/assets/skills/vitejs.svg" alt="icon" size={50} />,
      name: 'Vite',
    },
    {
      icon: <Image src="/assets/skills/typescript.svg" alt="icon" size={50} />,
      name: 'TypeScript',
    },
    {
      icon: <Image src="/assets/skills/nextjs.svg" alt="icon" size={50} />,
      name: 'Next',
    },
    {
      icon: <Image src="/assets/skills/jest.svg" alt="icon" size={50} />,
      name: 'Jest',
    },
    {
      icon: <Image src="/assets/skills/figma.svg" alt="icon" size={50} />,
      name: 'Figma',
    },
    {

                    ...
                    return (
                      <li key={index}>
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            {/* icons */}
                            <TooltipTrigger className="flex justify-center items-center w-[150px] h-[150px]  bg-gradient-to-b from-[#8c8c8c25]  border border-white/10 rounded-xl group text-accent">
                              <div

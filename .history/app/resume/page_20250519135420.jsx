...
const skills = {
  ...
  skillsList: [
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'React' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'JavaScript' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'Node' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'TailwindCSS' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'SequelizeORM' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'PrismaORM' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'Git' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'GitHub' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'Docker' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'PostgresSQL' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'MongoDB' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'Wordpress' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'HTML5' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'CSS3' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'Vite' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'TypeScript' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'Next' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'Jest' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: 'Figma' },
    { icon: <Image src="/assets/skills/react.svg" alt="icon" size={50} />, name: '' },
  ],
};

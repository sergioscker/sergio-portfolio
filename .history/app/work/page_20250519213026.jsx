                  ...
                  return (
                    <li key={index} className="text-xl text-accent">
                      <TooltipProvider delayDuration={100}>
                        <Tooltip>
                          <TooltipTrigger className="w-[80px] h-[80px] p-8 rounded-md 
                           bg-gradient-to-b from-[#8c8c8c25] to-[#3d3d3d36] backdrop-blur-[4px] border border-white/10 flex justify-center items-center group">

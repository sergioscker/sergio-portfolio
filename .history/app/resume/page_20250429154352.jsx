                    ...
                    return (
                      <li key={index}>
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            {/* icons */}
                            <TooltipTrigger className="w-[150px] h-[150px] bg-[#232329] rounded-xl group text-accent">
                              <div
                                className="flex flex-col items-center justify-center text-6xl group-hover:text-accent-hover transition-all duration-300"
                                aria-label="icons"
                              >
                                {skill.icon}

                                <p className="mt-3 text-sm text-center text-white/80 p-2">
                                  {skill.name}
                                </p>
                              </div>
                            </TooltipTrigger>

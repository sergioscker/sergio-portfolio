                  ...
                  >
                    <div
                      className="w-[52px] h-[52px] xl:w-[72px] xl:h-[72px] 
                       bg-gradient-to-b from-[#8c8c8c25] to-[#3d3d3d36] backdrop-blur-[4px] border border-white/10 rounded-lg shadow-md text-accent rounded-md flex items-center justify-center"
                    >

...
const skills = {
  ...
  skillsList: [
    {
      icon: <Image src="/assets/skills/react.svg" alt="icon" width={50} height  />,
      name: 'React',
    },
    {
      icon: <Image src="/assets/skills/javascript.svg" alt="icon" width={50} height />,
      name: 'JavaScript',
    },
    {
      icon: <Image src="/assets/skills/node.svg" alt="icon" width={50} height />,
      name: 'Node',
    },
    {
      icon: <Image src="/assets/skills/tailwind.svg" alt="icon" width={50} height />,
      name: 'TailwindCSS',
    },
    {
      icon: <Image src="/assets/skills/sequelize.svg" alt="icon" width={50} height />,
      name: 'SequelizeORM',
    },
    {
      icon: <Image src="/assets/skills/prisma.svg" alt="icon" width={50} height />,
      name: 'PrismaORM',
    },
    {
      icon: <Image src="/assets/skills/git.svg" alt="icon" width={50} height />,
      name: 'Git',
    },
    {
      icon: <Image src="/assets/skills/github.svg" alt="icon" width={50} height />,
      name: 'GitHub',
    },
    {
      icon: <Image src="/assets/skills/docker.svg" alt="icon" width={50} height />,
      name: 'Docker',
    },
    {
      icon: <Image src="/assets/skills/postgres.svg" alt="icon" width={50} height />,
      name: 'PostgresSQL',
    },
    {
      icon: <Image src="/assets/skills/mongodb.svg" alt="icon" width={50} height />,
      name: 'MongoDB',
    },
    {
      icon: <Image src="/assets/skills/wordpress.svg" alt="icon" width={50} height />,
      name: 'Wordpress',
    },
    {
      icon: <Image src="/assets/skills/html5.svg" alt="icon" width={50} height />,
      name: 'HTML5',
    },
    {
      icon: <Image src="/assets/skills/css3.svg" alt="icon" width={50} height />,
      name: 'CSS3',
    },
    {
      icon: <Image src="/assets/skills/vitejs.svg" alt="icon" width={50} height />,
      name: 'Vite',
    },
    {
      icon: <Image src="/assets/skills/typescript.svg" alt="icon" width={50} height />,
      name: 'TypeScript',
    },
    {
      icon: <Image src="/assets/skills/nextjs.svg" alt="icon" width={50} height />,
      name: 'Next',
    },
    {
      icon: <Image src="/assets/skills/jest.svg" alt="icon" width={50} height />,
      name: 'Jest',
    },
    {
      icon: <Image src="/assets/skills/figma.svg" alt="icon" width={50} height />,
      name: 'Figma',
    },
    {
      icon: <Image src="/assets/skills/react.svg" alt="icon" width={50} height />,

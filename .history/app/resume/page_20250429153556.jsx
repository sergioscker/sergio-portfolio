                ...
                <ScrollArea className="h-[420px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {education.items.map((item, index) => (
                      <li
                        key={index}
                        className="bg-white/90 dark:bg-[#232329 h-[190px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1"
                      >
                          ...
                          <Tooltip>
                            ...
                            <TooltipTrigger className="flex justify-center items-center w-[150px] h-[150px] bg-[#232329] rounded-xl group text-accent">
                              ...
                              >
                                ...
                                <p className="mt-2 text-sm text-center text-white/80">{skill.name}</p>
                              </div>
                            </TooltipTrigger>
